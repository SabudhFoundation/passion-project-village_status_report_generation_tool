...
from school_report_gen_tool.src import utils, llm, prompts, constants
from school_report_gen_tool.src.config import settings
...
# 2. RENAMED ENTRY FUNCTION
def run_school_app():
    # 3. REMOVED st.set_page_config() - This is now handled in the master app.py
...
# 4. UPDATED TO RUN THE NEW FUNCTION
